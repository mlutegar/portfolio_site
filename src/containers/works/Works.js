...
const WebsiteIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M18.8586 15.5001C18.8586 19.5831 17.2271 23.2824 14.5778 25.9861M14.5776 5.01397C17.2271 7.71773 18.8586 11.4171 18.8586 15.5001M12.1419 15.5001C12.1419 11.4171 13.7733 7.71773 16.4228 5.01397M12.1419 15.5001C12.1419 19.5831 13.7733 23.2824 16.4228 25.9861"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  return (
    <div className="works-main" id="works">
      <div className="works-header">
        <h2 className="works-title">{works.title}</h2>
        <p className="works-subtitle">{works.subtitle}</p>
      </div>

      <div className="works-grid">
        {works.projects.map((project, i) => {
          const isWebsite = project.footerLink?.some(
            link => link.name === "Visitar Site"
          );
          ...
          return (
            <Link
              ...
              to={`/projeto/${slug}`}
              className="work-card"
              aria-label={`${project.projectName} — ver estudo de caso`}
            >
